package com.iroumec.eerd.attribute.attributable;
...
import com.iroumec.eerd.attribute.presences.Optional;
import com.iroumec.eerd.attribute.presences.Presence;
import com.iroumec.eerd.attribute.roles.Common;
...
public class DescAttrImpl implements DescriptiveAttributable {

    /**
     * List of {@code Attribute}.
     */
    ...
    final void makeCorrectionInDiagram(Attribute attribute) {
        ...
        com.iroumec.components.Component.addComponent(attribute, diagram);
