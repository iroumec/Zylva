...
import com.zylva.bdd.eerd.attribute.IdentifierAttributable;
import com.zylva.bdd.eerd.hierarchy.Hierarchy;
import com.zylva.bdd.eerd.relationship.Relationship;
import com.zylva.bdd.eerd.relationship.Relatable;
...
public final class EntityWrapper extends IdentifierAttributable implements Relatable {
     ...
     */
     public static void addEntity(EERDiagram diagram) {
        ...
        String name = getValidText(diagram);
