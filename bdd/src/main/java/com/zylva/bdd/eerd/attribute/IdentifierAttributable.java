package com.zylva.bdd.eerd.attribute;
...
import com.zylva.bdd.eerd.attribute.presences.Optional;
import com.zylva.bdd.eerd.attribute.presences.Presence;
import com.zylva.bdd.eerd.attribute.roles.Alternative;
import com.zylva.bdd.eerd.attribute.roles.Main;
import com.zylva.bdd.eerd.attribute.roles.Rol;
...
public abstract class IdentifierAttributable extends DescriptiveAttributable {
    ...
    protected void addAttribute(Rol rol, Presence presence, Cardinality cardinality) {
        ...
        String name = getValidText(this.diagram);
