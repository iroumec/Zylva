...
public abstract class Diagram extends JPanel implements Multilingual {
    ...
    private List<com.iroumec.core.Component> components = new ArrayList<>();
    private com.iroumec.core.Component draggedComponent = null;
    private Set<com.iroumec.core.Component> selectedComponents = new HashSet<>();
    ...
    public void paintComponent(Graphics g) {
        ...
        for (com.iroumec.core.Component component : this.components) {
    ...
    /**
     * Selects all those components inside the selection area.
     */
    ...
    /**
     * Ads a component to the diagram.
     *
     * @param component {@code Component} to be added.
     */
    final void addComponent(@NotNull com.iroumec.core.Component component) {

        try {
            if (!this.addingIsValid(component)) {
                return;
            }
        } catch (Exception e) {
            return;
        ...
        int index = Collections.binarySearch(
                this.components,
                component,
                Comparator.comparing(com.iroumec.core.Component::getDrawingPriority) // Cambiado aquí
        );
        if (index < 0) {
            index = -index - 1;
        }
     ...
     */
    protected abstract boolean addingIsValid(@NotNull com.iroumec.core.Component component);

    /**
     * Removes a component from the diagram and clean all the selected components.
     *
     * @param componentToRemove {@code Component} to be removed.
     */
    final void removeComponent(@NotNull com.iroumec.core.Component componentToRemove) {
    ...
    public void sortComponents() {
        ...
        this.components.sort(Comparator.comparing(com.iroumec.core.Component::getDrawingPriority));
    }

    /**
     * @return A list with all the selected components.
     */
    protected List<com.iroumec.core.Component> getSelectedComponents() {
        return (new ArrayList<>(selectedComponents));
    }

    /**
     * Sets the select state of all selected components in false.
     */
    public void cleanSelectedComponents() {

        for (com.iroumec.core.Component selectedComponent : selectedComponents) {
    ...
    /**
     * @return The x coordinate of the mouse in the diagram.
     */
    ...
    /**
     * @return The y coordinate of the mouse in the diagram.
     */
    ...
    protected List<com.iroumec.core.Component> getDiagramComponents() { return new ArrayList<>(this.components); }
    ...
    boolean existsComponent(com.iroumec.core.Component component) {
    ...
    public Point getCenterOfComponents(List<com.iroumec.core.Component> components) {
        ...
        for (com.iroumec.core.Component component : components) {
    ...
    private void handleMousePressed(MouseEvent e) {
        ...
        if (noComponenteThere(e.getX(), e.getY()) && !e.isControlDown()) {
            ...
            if (e.isControlDown()) {
                ...
                List<com.iroumec.core.Component> components = getDiagramComponents().reversed();
                for (com.iroumec.core.Component component : components) {
    ...
    private void handleControlClick() {
        for (com.iroumec.core.Component component : components.reversed()) {
    ...
    private void mostrarMenu(MouseEvent e) {
        ...
        if (e.isPopupTrigger()) {
            ...
            for (com.iroumec.core.Component component : getDiagramComponents().reversed()) {
                if (component.getBounds().contains(e.getPoint())) {
    ...
    private void loadDiagram() {
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                List<com.iroumec.core.Component> components = (List<com.iroumec.core.Component>) in.readObject();
        ...
        deleteKey.getActionMap().put("Supr", new AbstractAction() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (confirmation == JOptionPane.YES_OPTION) {
                    ...
                    for (com.iroumec.core.Component component : Diagram.this.getSelectedComponents()) {
                    ...
                    List<com.iroumec.core.Component> componentsToRemove = new ArrayList<>(Diagram.this.getSelectedComponents());
